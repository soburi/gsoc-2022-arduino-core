...
1. Generator: `tools/protoc-gen-arduinoif`
2. Options: `idl/proto/arduino_opts.proto`
3. IDL services: `idl/proto/*.proto`
...
Defined in `idl/proto/arduino_opts.proto` as `google.protobuf.MethodOptions` extensions:
...
1. `cpp_decl`
   Full C++ declaration string, for example `size_t write(const uint8_t *buffer, size_t size)`.
2. `source_virtual`
